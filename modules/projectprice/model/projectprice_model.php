...
class Projectprice_Model extends Model {
    ...
    public function getIdProject($id) {
        $query ="select $this->table.* ,items.name from $this->table left join items on $this->table.idItems=items.id  where $this->table.idProject =$id";
